  ...
  <>
    { !loading && !error && ( 
        <>
            ...
            <div 
                className="modal fade" id='addProjectModal' role="dialog" aria-labelledby="addProjectModalLabel">
            <div 
                ...
                <div 
                    ...
                    <h4 
                        className="modal-title" id="addProjectModalLabel">New Project</h4>
                        <button
                            type="button"
                            className="btn-close"
                    ...
                    <form onSubmit={onSubmit}>
                        ...
                        <div className="mb-3">
                            ...
                            <select className="form-select" id="status" value={status} onChange={ (e) => setStatus(e.target.value)}>
                                <option value="new">NotStarted</option>
